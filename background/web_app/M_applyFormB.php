...
if($isApplied){
	...
	//若为待激活用户，则为该用户执行激活操作
		...
		$url = 'http://127.0.0.1/yeeco_1.0/background/background_person/activate_user.php';
	...
	//若为未注册用户，为用户注册账号		
		...
		$url = 'http://127.0.0.1/yeeco_1.0/background/background_person/form_register.php';
...
function applyInsert($data){
	...
	if($uIdRes){
		...
		//打包数据<br />
		$data['uId'] = $uId;
		$url = 'http://127.0.0.1/yeeco_1.0/background/background_society/society_apply_form.php';
